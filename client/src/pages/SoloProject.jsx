                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        ...
                                        <ResourceCard
                                            ...
                                            actions={[
                                                ...
                                                { type: 'download', label: 'Download ZIP (main)', href: 'https://github.com/EMIRBEN001/NotReally_Pacman_AI_DS_Project.git' },
                                            ]}
                                       />
                        ...
                        <aside className="w-full">
                            <div className="sticky space-y-6">
                                ...
                                <div className="w-full p-6 bg-white border border-gray-200 rounded-lg mb-">
                                    <h5 className="mb-2 text-2xl font-normal tracking-tight text-gray-900">Author</h5>
