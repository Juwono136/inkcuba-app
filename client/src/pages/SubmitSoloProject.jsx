...
export default function SubmitSoloProject() {
  return (
    <div>
      <Navbar />
            ...
            <div className="p-4 max-w-3xl mx-auto"> 
                <div>
                    <h1 className="mb-1 text-xl font-normal tracking-tight text-black ">
                        Submit your Project (Individual)
                    </h1>
                ...
                <div className="w-full p-6 bg-white border border-gray-200 rounded-lg mb-3">
                    <h1 className="mb-2 text-lg font-normal tracking-tight text-gray-900">Lecturer Information</h1>
                        <div className="flex items-center rounded-lg mb-1">
                            <div className="flex-1 min-w-0 ms-2">
                                <fieldset className="fieldset">
                                    <legend className="fieldset-legend text-gray-500 truncate text-sm font-normal">Lecturer Name/ID</legend>
                                    <input type="text" placeholder="Enter lecturer name / ID" className="input input-md bg-white border border-gray-300 rounded-lg text-black" />
                                </fieldset>
                            </div>
                        </div>
                </div>
